...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            voice_overlay_assistant::login_hosted_account_command,
            voice_overlay_assistant::get_hosted_account_status_command,
            voice_overlay_assistant::logout_hosted_account_command,
            voice_overlay_assistant::get_hosted_billing_plans_command,
            voice_overlay_assistant::create_hosted_checkout_session_command,
